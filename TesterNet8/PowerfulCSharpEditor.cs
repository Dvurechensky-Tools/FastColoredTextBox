                ...
                if (e.ColumnIndex == 1)
                    ...
                    switch (item.type)
                    {
                        case ExplorerItemType.Class:
                            e.Value = TesterNet8.Properties.Resources.class_libraries;
                            return;
                        case ExplorerItemType.Method:
                            e.Value = TesterNet8.Properties.Resources.box;
                            return;
                        case ExplorerItemType.Event:
                            e.Value = TesterNet8.Properties.Resources.lightning;
                            return;
                        case ExplorerItemType.Property:
                            e.Value = TesterNet8.Properties.Resources.property;
                            return;
                    }
            }
            catch{;}
