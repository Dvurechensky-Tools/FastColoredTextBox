...
namespace TesterNet8
{
    public partial class GifImageDrawingSample : Form
    {
        ...
        public GifImageDrawingSample()
        {
            ...
            style.ImagesByText.Add(@":bb", TesterNet8.Properties.Resources.bye);
            style.ImagesByText.Add(@":D", TesterNet8.Properties.Resources.lol);
            style.ImagesByText.Add(@"8)", TesterNet8.Properties.Resources.rolleyes);
            style.ImagesByText.Add(@":@", TesterNet8.Properties.Resources.unsure);
            style.ImagesByText.Add(@":)", TesterNet8.Properties.Resources.smile_16x16);
            style.ImagesByText.Add(@":(", TesterNet8.Properties.Resources.sad_16x16);
